...
class PersonControllerTest {
    ...
    void postPerson() throws Exception{
        ...
        Person result = personRepository.findAll(Sort.by(Sort.Direction.DESC, "id")).get(0); // 가장 마지막 값을 가져옴(id를 알 수 없어서 이렇게 test)
    ...
    // personDto를 JSON 형식으로 serialize를 해줌
